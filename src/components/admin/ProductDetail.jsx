                        ...
                        {getAllProduct.map((item, index) => {
                            ...
                            return (
                                <tr key={index} className="text-pink-300">
                                    ...
                                    <td onClick={()=> navigate(`/updateproduct/${id}`)} className="h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-pink-100 stroke-slate-500 font-semibold  text-green-800 cursor-pointer ">
                                        Edit
                                    </td>
                                    <td onClick={()=> deleteProduct(id)} className="h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-pink-100 stroke-slate-500 font-semibold  text-red-500 cursor-pointer ">
                                        Delete
                                    </td>
                                </tr>
                            )
