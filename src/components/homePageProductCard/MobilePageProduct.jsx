...
const MobilePageProduct = () => {
    const categoryname = 'mobile'
                                            ...
                                            {filterProduct.map((item, index) => {
                                                ...
                                                return (
                                                    <div key={index} className="p-4 w-full md:w-1/4">
                                                        <div className="h-full border border-gray-300 rounded-xl overflow-hidden shadow-md cursor-pointer hover:shadow-xl transform hover:scale-105 transition-transform duration-300 ease-in-out hover:bg-white">
                                                            <img
...
export default MobilePageProduct;