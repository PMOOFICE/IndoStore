...
const AdminDashboard = () => {
    ...
    const { loading, setLoading, getAllProduct, getAllProductFunction, getAllUser, getAllOrder } = context
    console.log(getAllProduct)
    return (
        <Layout>
            <div className="p-2 bg-gray-400 py-10 min-h-screen">
                ...
                <div className="px-5">
                    ...
                    <div>
                        <Tabs>
                            <TabList className="flex flex-wrap text-center justify-center border-none">


                                <Tab className="p-4 md:w-1/3 w-full cursor-pointer ">
                                    <div className="border bg-pink-50 hover:bg-pink-100 border-pink-100 px-4 py-3 rounded-xl">
                                        ...
                                        <p className="text-pink-500 font-bold">Total Product</p>
                                    </div>
                                </Tab>
