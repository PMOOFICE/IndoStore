...
const UserDashboard = () => {
    ...
    return (
        <Layout>
            <div className=" container mx-auto px-4 py-5 lg:py-8 bg-gray-400">
                {/* Top  */}
                <div className="top ">
                    {/* main  */}
                            ...
                            return (
                                <div key={index}>
                                    {order.cartItems.map((item, index) => {
                                        ...
                                        const { status } = order
                                        return (
                                            <div key={index} className="mt-5 flex flex-col overflow-hidden rounded-xl border border-pink-100 md:flex-row cursor-pointer" onClick={() => navigate(`/order/${user?.uid}`)}>
                                                {/* main 3  */}
                                                <div className="w-full border-r border-pink-100 bg-pink-50 md:max-w-xs cursor-pointer" >
                                                    {/* left  */}
                                                    <div className="p-8">
